...
const projects = [
	...
	// ============================================
	{
		...
		description:
			"A revolutionary dual-AI architecture where Klein serves humanity while Ophir watches Klein — creating a self-regulating system that protects human agency by design. Research thesis for Naval Postgraduate School.",
	...
	},
	{
		...
		description:
			"Unified platform integrating all TechKlein projects, services, and solutions. Central hub for AI governance, fintech, education, defense, and community impact initiatives.",
	...
	},
	{
		...
		description:
			"Comprehensive documentation of TechKlein's philosophy, values, operational standards, and vision. The guiding principles for all TechKlein initiatives.",
	...
	},
	{
		...
		description:
			"Custom-built supercomputer powered by dual RTX 4090 GPUs or DGX system. Designed for KleinAI training, inference, and research workloads.",
		category: ProjectCategory.INFRASTRUCTURE,
		status: ProjectStatus.IN_PROGRESS,
	...
	},
	{
		...
		description:
			"Comprehensive training platform offering courses in AI development, cybersecurity, and advanced computing. Designed to upskill the next generation of engineers.",
	...
	},
	{
		...
		description:
			"Enterprise-grade call center platform with AI-assisted routing, sentiment analysis, and automated support. Creating jobs and economic opportunities.",
		category: ProjectCategory.WEB_APP,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"Comprehensive defense and security platform integrating threat detection, monitoring, and response systems for military and government applications.",
	...
	},
	{
		...
		description:
			"Community-driven food distribution initiative leveraging technology to efficiently deliver aid and nutrition support to underserved communities in Haiti.",
		category: ProjectCategory.COMMUNITY,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"Transparent, secure digital voting and polling platform providing real-time election results with blockchain-verified integrity.",
	...
	// ============================================
	{
		...
		description:
			"Comprehensive study and exam preparation platform for Haitian students preparing for the Baccalauréat. Interactive lessons, practice tests, and progress tracking.",
		category: ProjectCategory.EDUCATION,
		status: ProjectStatus.IN_PROGRESS,
	...
	},
	{
		...
		description:
			"Specialized facility and platform providing safe, sensory-friendly environments for autistic children and families. Building understanding through technology and care.",
		category: ProjectCategory.COMMUNITY,
		status: ProjectStatus.PLANNED,
		technologies: ["React Native", "PostgreSQL", "Node.js"],
	},
	{
		...
		description:
			"Real-time interactive platform for Haitian football fans during World Cup qualification campaigns. Live updates, predictions, and community engagement.",
		category: ProjectCategory.WEB_APP,
		status: ProjectStatus.PLANNED,
	...
	// ============================================
	{
		...
		description:
			"Custom intrusion detection system using machine learning to identify and respond to network threats in real-time. Trained on military-grade threat intelligence.",
		category: ProjectCategory.MILITARY,
	...
	},
	{
		...
		description:
			"Digital automation system replacing paper-based CIC watch logs. Real-time alerts, 12 O'Clock Reports, Bell Ringing Protocols, CAC authentication, and audit logging.",
		category: ProjectCategory.MILITARY,
		status: ProjectStatus.IN_PROGRESS,
		featured: true,
	...
	},
	{
		...
		description:
			"Comprehensive watch bill management and scheduling system for naval operations. Built with Python, C++, and React for maximum performance and reliability.",
		category: ProjectCategory.MILITARY,
		status: ProjectStatus.IN_PROGRESS,
	...
	},
	{
		...
		description:
			"DoD-level military wearable with AI emotional/mental state monitoring. Real-time physiological tracking, stress detection, and command-level intelligence for mission readiness.",
		category: ProjectCategory.MILITARY,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"Integration of NVIDIA DGX systems for high-performance AI security workloads. Advanced threat detection, pattern analysis, and autonomous response.",
		category: ProjectCategory.INFRASTRUCTURE,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"Emergency alert system for immigrant communities. Real-time notifications, safety resources, and community coordination.",
		category: ProjectCategory.COMMUNITY,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"P2P marketplace platform enabling Haitians to buy, sell, and trade locally. Building Haiti's digital commerce economy.",
		category: ProjectCategory.WEB_APP,
		status: ProjectStatus.PLANNED,
	...
	},
	{
		...
		description:
			"Integrated sports betting platform with live streaming, real-time odds, and secure payment processing.",
		category: ProjectCategory.WEB_APP,
		status: ProjectStatus.PLANNED,
	...
	// ============================================
	{
		...
		description:
			"Self-hosted infrastructure for media server, home automation, development environments, and AI workloads. Complete with PiKVM remote management.",
		category: ProjectCategory.INFRASTRUCTURE,
		status: ProjectStatus.IN_PROGRESS,
	...
	},
	{
		...
		description:
			"Comprehensive automation workflows connecting all TechKlein systems. Data pipelines, notifications, and integrations.",
		category: ProjectCategory.INFRASTRUCTURE,
		status: ProjectStatus.IN_PROGRESS,
	...
	},
	{
		...
		description:
			"Secure remote KVM-over-IP solution for managing servers from anywhere. Integrated with Tailscale for zero-trust networking.",
		category: ProjectCategory.INFRASTRUCTURE,
		status: ProjectStatus.COMPLETED,
	...
	// ============================================
	{
		...
		description:
			"Modern, responsive portfolio showcasing projects, experience, and vision. Built with Next.js and beautiful animations.",
		category: ProjectCategory.WEB_APP,
		status: ProjectStatus.IN_PROGRESS,
		featured: true,
	...
	},
	{
		...
		description:
			"Photorealistic 3D avatar representing Klein AI. Interactive, expressive, and built using Unreal Engine MetaHuman technology.",
		category: ProjectCategory.AI_ML,
		status: ProjectStatus.PLANNED,
	...
	// ============================================
	{
		...
		description:
			"Full multi-chapter academic thesis on defensive dual-AI architecture. Explores self-governing AI systems that protect humanity by protecting us from themselves.",
		category: ProjectCategory.AI_ML,
		status: ProjectStatus.IN_PROGRESS,
		featured: true,
