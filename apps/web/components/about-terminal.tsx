...
const commands = [
	...
	},
	{
		...
		output:
			"Founder of TechKlein LLC — a U.S.-based AI, cybersecurity, and digital innovation company.",
	},
	{
		command: "mission --display",
		output:
			"To engineer intelligent systems that empower people, strengthen security, and shape the future responsibly.",
	},
	{
					...
					<Card className="glass-strong border-primary/20 overflow-hidden">
						...
						<div className="p-6 font-mono text-sm space-y-4 min-h-[400px]">
							...
							{currentLine >= commands.length && (
								...
								>
									<p className="mb-4">
										I'm <span className="text-primary font-semibold">Erickharlein Pierre</span>, a
										U.S. Navy Systems Engineer and AI Architect driven by purpose and precision.
									</p>
									<p className="mb-4">
										My work blends operational discipline with cutting-edge engineering to build
										systems that <span className="text-cyan-400">think</span>,{" "}
										<span className="text-violet-400">protect</span>, and{" "}
