...
import { Brain, Cloud, Code2, Database, Lock, Shield, Users, Zap } from "lucide-react";
			...
			<div className="container">
				...
				>
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
						Fusing military precision with cutting-edge technology to build secure, intelligent, and
						scalable systems.
					</p>
				</motion.div>
