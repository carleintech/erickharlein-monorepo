...
import { ArrowRight, Code2, Sparkles, Zap, Calculator } from "lucide-react";
					...
					>
						...
						<Link href="/booking">
							...
							>
								<Button 
									size="lg" 
									className="group relative overflow-hidden bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:shadow-2xl hover:shadow-green-500/50 transition-all duration-300"
								>
									<span className="relative z-10 flex items-center gap-2">
									...
									<motion.div
										className="absolute inset-0 bg-gradient-to-r from-teal-500 via-emerald-500 to-green-500"
										initial={{ x: "100%" }}
										whileHover={{ x: 0 }}
										transition={{ duration: 0.3 }}
									/>
