          ...
          <div className="relative glass-strong rounded-2xl p-12 text-center space-y-8 border border-primary/20">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Whether you need consultation, technical review, or want to discuss a project — I'm here to help build
            ...
            >
              ...
              <Link href="/contact">
                <Button size="lg" variant="outline" className="glass border-primary/50 hover:border-primary">
