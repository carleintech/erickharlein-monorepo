	...
	return (
		<div className="relative min-h-screen">
			...
			<div className="fixed inset-0 -z-10 overflow-hidden">
				<div
					className="absolute top-20 right-10 h-96 w-96 rounded-full bg-gradient-to-br from-cyan-500/30 to-blue-500/30 blur-3xl animate-pulse"
				...
				/>
				<div
					className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-gradient-to-br from-emerald-500/20 to-teal-500/20 blur-3xl animate-pulse"
			...
			<div className="container py-12 max-w-6xl">
				...
				<div className="space-y-6 mb-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
						Schedule a one-on-one session to discuss your project, get technical advice, or explore
								...
								{services.map((service, index) => (
									...
									>
										<div className="flex items-start gap-4">
											<div
												className={`flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${service.gradient} text-2xl flex-shrink-0 group-hover:scale-110 transition-transform`}
											>
												{service.icon}
											</div>
											<div className="flex-1 space-y-2">
												<div className="flex items-start justify-between gap-2">
													...
													<span
														className={`px-2 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${service.gradient} text-white flex items-center gap-1 whitespace-nowrap`}
													>
							...
							<CardContent className="space-y-6">
								<div className="flex gap-4 group">
									...
									<div>
										...
										<p className="text-sm text-muted-foreground leading-relaxed">
											Choose the service type and preferred date/time
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4 group">
									...
									<div>
										...
										<p className="text-sm text-muted-foreground leading-relaxed">
											Fill out the form with your information and needs
										</p>
									</div>
								</div>
						...
						>
							<CardContent className="pt-6 flex items-start gap-4">
								...
								<div className="space-y-2">
									...
									<p className="text-sm text-muted-foreground leading-relaxed">
										All consultations are conducted via video call (Zoom, Google Meet, or Microsoft
										Teams). Link will be provided in your confirmation email.
									</p>
								</div>
							</CardContent>
						</Card>
