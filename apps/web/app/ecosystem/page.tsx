...
const ecosystemProducts = [
  {
    ...
    description: 'Revolutionary dual-AI governance system where Klein serves humanity while Ophir watches Klein — creating self-regulating AI that protects human agency by design.',
  ...
  },
  {
    ...
    description: 'Unified platform integrating all TechKlein projects, services, and solutions. Central hub for AI governance, fintech, education, defense, and community impact.',
  ...
  },
  {
    ...
    description: 'Digital automation replacing paper-based CIC watch logs. Real-time alerts, 12 O\'Clock Reports, Bell Ringing Protocols, CAC authentication, and audit logging.',
    status: 'Active Development',
    category: 'Defense',
    gradient: 'from-blue-600 to-indigo-600',
    icon: '🛡️',
    links: [
      { label: 'View Project', url: '/projects/watchlog-ai' },
    ],
  },
  {
    id: 'baccplus',
    ...
    description: 'Comprehensive study and exam preparation platform for Haitian students. Interactive lessons, practice tests, and progress tracking for academic success.',
    status: 'In Development',
    category: 'Education',
  ...
  },
  {
    ...
    icon: '💻',
    links: [
      { label: 'View Project', url: '/projects/kleinos' },
    ],
  },
  {
    ...
    description: 'Comprehensive training offering courses in AI development, cybersecurity, and advanced computing. Upskilling the next generation of engineers.',
    status: 'Planned',
    category: 'Education',
    gradient: 'from-pink-500 to-rose-500',
    icon: '🎓',
    links: [
      { label: 'View Project', url: '/projects/techklein-academy' },
    ],
  },
  {
    id: 'vigil',
    ...
    description: 'DoD-level military wearable with AI emotional/mental state monitoring. Real-time physiological tracking and stress detection for mission readiness.',
    status: 'Planned',
    category: 'Defense',
    gradient: 'from-red-500 to-orange-500',
    icon: '⌚',
    links: [
      { label: 'View Project', url: '/projects/vigil' },
    ],
  },
  {
    id: 'ayitiritmo',
  ...
  },
  {
    ...
    description: 'Community-driven food distribution initiative leveraging technology to efficiently deliver aid and nutrition support to underserved communities.',
    status: 'Planned',
    category: 'Community',
  ...
  },
  {
    ...
    description: 'P2P marketplace enabling Haitians to buy, sell, and trade locally. Building Haiti\'s digital commerce economy.',
    status: 'Planned',
    category: 'E-Commerce',
  ...
  },
  {
    ...
    icon: '💎',
    links: [
      { label: 'View Project', url: '/projects/kleincard' },
    ],
  },
  {
    id: 'sentinel-wms',
    ...
    description: 'Comprehensive watch bill management and scheduling system for naval operations. Built for maximum performance and reliability.',
    status: 'In Development',
    category: 'Defense',
    gradient: 'from-indigo-500 to-purple-500',
    icon: '📋',
    links: [
      { label: 'View Project', url: '/projects/sentinel-wms' },
    ],
  },
  {
    id: 'caring-compass',
  ...
  },
  {
    ...
    icon: '🎨',
    links: [
      { label: 'View Project', url: '/projects/noesis' },
    ],
  },
];
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-20 right-10 h-96 w-96 rounded-full bg-gradient-to-br from-purple-500/30 to-pink-500/30 blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-20 left-10 h-96 w-96 rounded-full bg-gradient-to-br from-indigo-500/30 to-cyan-500/30 blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-gradient-to-br from-rose-500/20 to-orange-500/20 blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
      </div>
      ...
      <div className="container mx-auto px-4 py-16 space-y-16">
        ...
        <div className="text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A comprehensive suite of AI-powered solutions spanning defense, fintech, education, and community impact. 
            Each product designed to solve real problems and create lasting change.
          </p>
        </div>
            ...
            >
              ...
              <CardHeader className="space-y-3">
                <div className="flex items-start justify-between gap-4">
                  <div className={`flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${product.gradient} text-4xl`}>
                    {product.icon}
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${product.gradient} bg-opacity-20 text-white/90`}>
                    {product.category}
                  </span>
                </div>
        ...
        {/* Vision Statement */}
        <Card className="glass-strong border-2 border-purple-500/30 animate-in fade-in slide-in-from-bottom-4" style={{ animationDelay: '1600ms' }}>
          <CardHeader>
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p className="text-lg">
              TechKlein exists at the intersection of innovation and impact. We build technology that matters — 
              systems that protect, empower, educate, and connect.
            </p>
            <p>
              From AI governance systems that put humanity first, to fintech solutions opening economic doors in Haiti, 
              to defense platforms keeping our servicemembers safe — every product in our ecosystem serves a purpose 
              beyond profit.
            </p>
