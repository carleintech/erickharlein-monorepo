import { Mail, Phone, MapPin, Linkedin, Github, MessageSquare, Send, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-20 right-10 h-96 w-96 rounded-full bg-gradient-to-br from-blue-500/30 to-cyan-500/30 blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-gradient-to-br from-indigo-500/20 to-violet-500/20 blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
      </div>
              ...
              <CardContent className="space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-foreground group-hover:text-blue-400 transition-colors">Email</div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-foreground group-hover:text-green-400 transition-colors">WhatsApp</div>
            ...
            <Card className="glass hover:scale-[1.01] transition-all duration-300 animate-in fade-in slide-in-from-bottom-4" style={{ animationDelay: '400ms' }}>
              ...
              <CardContent className="space-y-4">
                ...
                >
                  ...
                  <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">github.com/erickharlein</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">linkedin.com/in/erickharlein</span>
                </a>
              </CardContent>
            </Card>
            ...
            <Card className="glass-strong border-2 border-indigo-500/30 animate-in fade-in slide-in-from-bottom-4" style={{ animationDelay: '600ms' }}>
              <CardContent className="pt-6 space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Consider booking a dedicated time slot for a more structured discussion about your project needs. I'm here to help bring your ideas to life.
                </p>
              </CardContent>
            </Card>
          </div>
