import { Shield, Code2, GraduationCap, Heart, Globe, Coffee, Music, Plane } from "lucide-react";
import {
	Card,
	CardContent,
	CardDescription,
	...
	return (
		<div className="relative min-h-screen">
			...
			<div className="fixed inset-0 -z-10 overflow-hidden">
				...
				{/* Animated Orbs */}
				<div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-indigo-400/30 to-purple-400/30 dark:from-indigo-500/20 dark:to-purple-500/20 rounded-full blur-3xl animate-pulse" 
					style={{ animationDuration: '4s' }} />
				<div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-pink-400/30 to-rose-400/30 dark:from-pink-500/20 dark:to-rose-500/20 rounded-full blur-3xl animate-pulse" 
					style={{ animationDuration: '6s', animationDelay: '1s' }} />
				<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-cyan-400/20 to-blue-400/20 dark:from-cyan-500/10 dark:to-blue-500/10 rounded-full blur-3xl animate-pulse" 
			...
			<div className="container py-12 max-w-5xl relative z-10">
				...
				<div className="space-y-6 mb-16 text-center">
					...
					<p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
						But everyone calls me <span className="font-semibold text-foreground">Carleintech</span>. I'm a sailor, 
						engineer, husband, and father who believes technology should make life better — not replace what makes us human.
					</p>
				</div>
			...
			<Card className="mb-12 glass border-primary/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.01] animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
				<CardHeader>
					...
					<CardDescription className="text-base">From Haiti to the U.S. Navy to building the future</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4 text-base leading-relaxed">
					<p className="text-foreground">
						I grew up speaking French and Haitian Creole, and when I came to the United States, I had to learn 
						English from scratch. That challenge taught me something fundamental: <span className="font-semibold">
						barriers are just problems waiting for solutions.</span>
					</p>
					<p className="text-muted-foreground">
						On June 14, 2021, I enlisted in the U.S. Navy with a clear purpose: to serve, to grow, and to prove 
						that determination matters more than circumstances. I became an Operations Specialist, working in the 
						Combat Information Center aboard USS New Orleans (LPD-18), managing combat systems, navigation, and 
						tactical operations.
					</p>
					<p className="text-muted-foreground">
						But I didn't stop there. While serving full-time, I self-funded my bachelor's degree in Computer 
						Network Engineering and Cybersecurity from the University of Maryland Global Campus. I graduated 
						in December 2023 — all while supporting my wife and our 1-year-old son.
					</p>
					<p className="text-muted-foreground">
						Today, I'm pursuing <span className="font-semibold text-foreground">two master's degrees simultaneously</span> — 
						one at the Naval Postgraduate School in Applied Computing and another at Western Governors University 
						in Cybersecurity and Information Assurance. My end of service is May 2026, and I'm applying for Officer 
						Candidate School because I joined to lead, not just to serve.
					</p>
				</CardContent>
			</Card>
				...
				<div className="grid md:grid-cols-2 gap-6">
					<Card className="glass border-pink-500/30 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] group animate-in fade-in slide-in-from-left-4 duration-1000 delay-400">
						...
						<CardContent className="space-y-3 text-sm text-muted-foreground leading-relaxed">
							<p>
								I'm a proud husband and father. My wife and 1-year-old son are my motivation for everything 
								I do. Balancing military service, two master's programs, and family life isn't easy — but 
								it's taught me what really matters: being present, staying disciplined, and never losing sight 
								of why I started.
							</p>
							<p>
								Every late night studying, every system I build, every line of code I write — it's all for them.
							</p>
						</CardContent>
					</Card>
					...
					<Card className="glass border-purple-500/30 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] group animate-in fade-in slide-in-from-right-4 duration-1000 delay-400">
						...
						<CardContent className="space-y-3 text-sm text-muted-foreground leading-relaxed">
							<p>
								I don't believe AI should replace people. I believe it should <span className="font-semibold text-foreground">
								elevate them</span>. That's why I'm building KleinAI — a system designed to answer "Who watches 
								the watcher?" by creating AI that protects humanity by protecting us from itself.
							</p>
							<p>
								My Naval Postgraduate School thesis focuses on this: dual-AI architecture that ensures ethical 
								autonomy and self-regulation. It's not just research — it's my vision for responsible AI.
							</p>
						</CardContent>
					</Card>
				</div>
					...
					<div className="space-y-6">
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/5 border border-primary/20 hover:border-primary/40 transition-all duration-300">
							...
							<div className="space-y-2">
								<h4 className="font-semibold text-foreground text-lg">U.S. Navy Operations Specialist</h4>
								<p className="text-sm text-muted-foreground leading-relaxed">
									Currently stationed at EWTGLANT as an instructor for AADS CIC Boat Control. Previously served 
									aboard USS New Orleans (LPD-18) managing combat systems (AADS, SSDS), navigation (VMS, ECDIS), 
									and tactical operations. Qualified as Piloting Officer and MWR Vice President. Scored 56 on the 
									OAR — applying for Officer Candidate School.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-purple-500/5 to-pink-500/10 dark:from-purple-500/10 dark:to-pink-500/5 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-muted-foreground leading-relaxed">
									<span className="font-semibold text-foreground">Naval Postgraduate School</span> — Master of Applied Computing (MAC), Curriculum 367
									<br />
									<span className="font-semibold text-foreground">Western Governors University</span> — Master of Science in Cybersecurity & Information Assurance
									<br />
									<span className="font-semibold text-foreground">University of Maryland Global Campus</span> — B.S. Computer Network Engineering & Cybersecurity (Dec 2023)
								</p>
							</div>
						</div>
						...
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-cyan-500/5 to-indigo-500/10 dark:from-cyan-500/10 dark:to-indigo-500/5 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-muted-foreground leading-relaxed">
									8+ years building intelligent systems. CompTIA Security+ certified, currently pursuing CC and CISSP. 
									Full-stack engineering (TypeScript, React, Next.js, Node.js), cloud architecture (AWS, Azure, GCP), 
									AI/ML development (Python, TensorFlow), and cybersecurity. Trilingual: English, French, Haitian Creole.
								</p>
							</div>
						</div>
					</div>
			...
			<Card className="mb-12 glass border-rose-500/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.01] animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-600">
				<CardHeader>
					...
					<CardDescription className="text-base">What I do when I'm not building systems</CardDescription>
				</CardHeader>
				<CardContent>
					<div className="grid md:grid-cols-2 gap-6">
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-rose-500/5 to-pink-500/10 dark:from-rose-500/10 dark:to-pink-500/5 border border-rose-500/20 hover:border-rose-500/40 transition-all duration-300 group">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-muted-foreground">
									I love exploring different music genres — from Haitian konpa to American hip-hop. Music connects 
									cultures, and I appreciate how it tells stories across languages.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-amber-500/5 to-orange-500/10 dark:from-amber-500/10 dark:to-orange-500/5 border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 group">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-muted-foreground">
									Always reading, always learning. Whether it's AI research papers, cybersecurity frameworks, 
									or naval tactics — I believe growth never stops.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-sky-500/5 to-cyan-500/10 dark:from-sky-500/10 dark:to-cyan-500/5 border border-sky-500/20 hover:border-sky-500/40 transition-all duration-300 group">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-muted-foreground">
									From Haiti to the U.S., and across the world through Navy deployments — I love experiencing 
									new places, cultures, and perspectives.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-4 p-4 rounded-lg bg-gradient-to-br from-emerald-500/5 to-green-500/10 dark:from-emerald-500/10 dark:to-green-500/5 border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 group">
							...
							<div className="space-y-1">
								...
								<p className="text-sm text-muted-foreground">
									As MWR Vice President, I learned that leadership is about lifting others up. I mentor junior 
									sailors and aspiring engineers whenever I can.
								</p>
							</div>
						</div>
					</div>
				...
				<CardContent>
					<div className="grid md:grid-cols-2 gap-6">
						<div className="space-y-2 p-5 rounded-lg bg-gradient-to-br from-indigo-500/5 to-purple-500/10 dark:from-indigo-500/10 dark:to-purple-500/5 border border-indigo-500/20 hover:border-indigo-500/40 transition-all duration-300">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								I learned English from scratch, self-funded my education, and balanced military service with 
								family and academics. If you want something badly enough, you find a way.
							</p>
						</div>
						...
						<div className="space-y-2 p-5 rounded-lg bg-gradient-to-br from-blue-500/5 to-cyan-500/10 dark:from-blue-500/10 dark:to-cyan-500/5 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								The Navy taught me that honor, courage, and commitment aren't just words — they're principles 
								you live by. Leadership is earned through action, not rank.
							</p>
						</div>
						...
						<div className="space-y-2 p-5 rounded-lg bg-gradient-to-br from-purple-500/5 to-pink-500/10 dark:from-purple-500/10 dark:to-pink-500/5 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								AI should empower teachers, doctors, engineers, and service members — not replace them. Every 
								system I build is designed to elevate human potential.
							</p>
						</div>
						...
						<div className="space-y-2 p-5 rounded-lg bg-gradient-to-br from-emerald-500/5 to-green-500/10 dark:from-emerald-500/10 dark:to-green-500/5 border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								Two master's degrees while serving full-time. CompTIA Security+, working toward CISSP. Because 
								excellence isn't a destination — it's a commitment to constant improvement.
							</p>
						</div>
					</div>
				</CardContent>
			...
			<div className="mt-12 text-center space-y-4 animate-in fade-in duration-1000 delay-500">
				<p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
					I'm not just building technology — I'm building a future where AI respects human autonomy, 
					where service members have smarter tools, and where families like mine can thrive. 
				</p>
